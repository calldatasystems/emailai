...
import { whitelistemailaiAction } from "@/utils/actions/whitelist";
import {
...
export function AssessUser() {
  ...
  const { execute: executeWhitelistemailai } = useAction(
    whitelistemailaiAction.bind(null, emailAccountId),
  );
