...
const title = "EmailAI | Your AI Email Assistant";
const description =
  "EmailAI is your AI personal assistant for email. Automate your email, bulk unsubscribe from newsletters, block cold emails, and view your email analytics. Open-source.";
