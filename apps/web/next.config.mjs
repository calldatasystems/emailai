  ...
  async redirects() {
    return [
      ...
      },
      {
        ...
        destination: "https://emailai.featurebase.app",
        permanent: true,
      },
      {
        source: "/feedback",
      ...
      {
        source: "/roadmap",
        destination: "https://emailai.featurebase.app/roadmap",
        permanent: true,
      },
      {
        source: "/changelog",
        destination: "https://emailai.featurebase.app/changelog",
        permanent: true,
      },
      {
        source: "/twitter",
        destination: "https://twitter.com/emailai_ai",
        permanent: true,
      },
      {
        source: "/github",
      ...
      {
        source: "/affiliates",
        destination: "https://emailai.lemonsqueezy.com/affiliates",
        permanent: true,
      },
      {
        source: "/newsletters",
