import { deleteContact as deleteLoopsContact } from "@emailai/loops";
import { deleteContact as deleteResendContact } from "@emailai/resend";
import prisma from "@/utils/prisma";
import { deleteemailaiLabels, deleteUserLabels } from "@/utils/redis/label";
import { deleteTinybirdAiCalls } from "@emailai/tinybird-ai-analytics";
...
async function deleteResources({
  ...
  const resourcesPromise = Promise.allSettled([
    ...
    deleteemailaiLabels({ emailAccountId }),
